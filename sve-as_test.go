...
func TestSveAssembler(t *testing.T) {
	testCases := []struct {
		...
		// ror (SVE2 pseudo-instruction, maps to xar z, z, z, #imm)
		{"    WORD $0x04f33400 // ror z0.d, z0.d, #13"},
		{"    WORD $0x04a1354a // ror z10.d, z10.d, #63"},
		{"    WORD $0x04793400 // ror z0.s, z0.s, #7"},
		{"    WORD $0x043d3400 // ror z0.h, z0.h, #3"},
		{"    WORD $0x042f3400 // ror z0.b, z0.b, #1"},
		...
		{"    WORD $0x048381a0 // lsl z0.d, p0/m, z0.d, #13"},
		{"    WORD $0x044380e0 // lsl z0.s, p0/m, z0.s, #7"},
		{"    WORD $0x04038260 // lsl z0.h, p0/m, z0.h, #3"},
		{"    WORD $0x04038120 // lsl z0.b, p0/m, z0.b, #1"},
		{"    WORD $0x04c397ea // lsl z10.d, p5/m, z10.d, #63"},
		...
		// cls (count leading sign bits) and rbit (reverse bits) — SVE predicated
		{"    WORD $0x04d8a020 // cls z0.d, p0/m, z1.d"},
		{"    WORD $0x0498a020 // cls z0.s, p0/m, z1.s"},
		{"    WORD $0x0418a020 // cls z0.b, p0/m, z1.b"},
		{"    WORD $0x04d8ae8f // cls z15.d, p3/m, z20.d"},
		{"    WORD $0x05e78020 // rbit z0.d, p0/m, z1.d"},
		{"    WORD $0x05a78020 // rbit z0.s, p0/m, z1.s"},
		{"    WORD $0x05278020 // rbit z0.b, p0/m, z1.b"},
		{"    WORD $0x05a79c1f // rbit z31.s, p7/m, z0.s"},
		...
		{"    WORD $0x05f23840 // uunpklo z0.d, z2.s"},
		{"    WORD $0x05f33841 // uunpkhi z1.d, z2.s"},
		{"    WORD $0x05f03840 // sunpklo z0.d, z2.s"},
		{"    WORD $0x05f13841 // sunpkhi z1.d, z2.s"},
		{"    WORD $0x05723840 // uunpklo z0.h, z2.b"},
		{"    WORD $0x05b33841 // uunpkhi z1.s, z2.h"},
		{"    WORD $0x25e12000 // ctermeq x0, x1"},
		{"    WORD $0x25f42140 // ctermeq x10, x20"},
		{"    WORD $0x25e12010 // ctermne x0, x1"},
		{"    WORD $0x04da2040 // andv d0, p0, z2.d"},
		{"    WORD $0x041a2040 // andv b0, p0, z2.b"},
		{"    WORD $0x04d82040 // orv d0, p0, z2.d"},
		{"    WORD $0x04982d40 // orv s0, p3, z10.s"},
		{"    WORD $0x04d92040 // eorv d0, p0, z2.d"},
		{"    WORD $0x05282062 // dup z2.d, d3"},
		{"    WORD $0x052420a0 // dup z0.s, s5"},
		{"    WORD $0x05222140 // dup z0.h, h10"},
		{"    WORD $0x052121e0 // dup z0.b, b15"},
		{"    WORD $0x05282062 // mov z2.d, d3"},
		{"    WORD $0x052420a0 // mov z0.s, s5"},
		...
		{"    WORD $0x05f43820 // insr z0.d, d1"},
		{"    WORD $0x05b43820 // insr z0.s, s1"},
		{"    WORD $0x05743820 // insr z0.h, h1"},
		{"    WORD $0x05343820 // insr z0.b, b1"},
		{"    WORD $0x05f43a8a // insr z10.d, d20"},
